...
template<typename QueueId, typename Value>
Processor<QueueId, Value>::Processor()
    : Processor(OverflowPolicy::Default, Const::ThreadCountNotSpecified, Const::DefaultMaxQueueSize)
{
}
...
template<typename QueueId, typename Value>
Processor<QueueId, Value>::Processor(unsigned int threadCount)
    : Processor(OverflowPolicy::Default, threadCount, Const::DefaultMaxQueueSize)
{
}
